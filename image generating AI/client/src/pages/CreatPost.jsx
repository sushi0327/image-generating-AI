  ...
  return (
    <section className="max-w-7xl mx-auto ">
      ...
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[17px] max-w[500px]">Create imaginative and visually stunning images through DALL-E-AI and share them with the community</p>
      </div>
